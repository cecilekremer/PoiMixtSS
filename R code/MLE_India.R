...
######################################################################################################
### DATA EXAMPLE 2                                                                                 ###
### Laxminarayan et al. "Epidemiology and transmission dynamics of COVID-19 intwo Indian states".  ### 
### In:Science(2020).doi:10.1126/science.abd7672.                                                  ###
######################################################################################################
...
# jpeg("propIndia.jpeg", width = 18, height = 15, units = 'cm', res = 1200)
plot(a,prop.NB,type="l",col="blue", xlab="Proportion of infectious cases",ylab="Expected proportion of transmission",main="(c)")
prop.LN <-c()
...
# p80%
abline(h=0.8,lty=2)
abline(v=a[319],lty=3,col="blue")
abline(v=a[373],lty=3,col="purple")
abline(v=a[323],lty=3,col="orange")
abline(v=a[334],lty=3,col="red")
# dev.off()
...
## Figure 2d
# jpeg("propIndia3.jpeg", width = 18, height = 15, units = 'cm', res = 1200)
plot(prop.NB$x1,prop.NB$Prop,type="n",pch=15,col="dimgray",main="(d)",xlab="Proportion of infectious cases",ylab="Realized proportion of transmission",ylim=c(0,1),xlim=c(0,max.p+0.05))
...
n.sec = nsec
# jpeg("fitPareto2.jpeg", width = 22, height = 12, units = 'cm', res = 1200)
par(mfrow=c(1,2))
